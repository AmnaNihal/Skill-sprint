...
import {
  Sparkles, Shield, ArrowRight, Users,
  FileSearch, Layers, BarChart3
} from 'lucide-react';
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-20 lg:pt-16 lg:pb-32 flex-1 flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="flex-1 max-w-2xl text-center lg:text-left space-y-6">
          ...
          <p className="text-lg text-slate-300 leading-relaxed font-normal">
            Automate onboarding curriculum generation, audit compliance against internal technical docs,
            and guarantee 100% role-aligned skills mastery with mathematical rigor.
          </p>
