...
export const WorkflowFooter: React.FC = () => {
  ...
  const workflowSteps: { tab: NavigationTab; label: string; num: string }[] = [
    ...
    { tab: 'employees', label: 'Employees', num: '04' },
    { tab: 'documents', label: 'Docs', num: '05' },
    { tab: 'matrix', label: 'Matrix', num: '06' },
    { tab: 'generatePlan', label: 'Synthesis', num: '07' },
    { tab: 'planDetails', label: 'Plan', num: '08' },
    { tab: 'validation', label: 'Validation', num: '09' },
    { tab: 'reviews', label: 'Approval', num: '10' },
    { tab: 'learnerDashboard', label: 'Learner', num: '11' },
    { tab: 'reports', label: 'Reports', num: '12' },
  ];
